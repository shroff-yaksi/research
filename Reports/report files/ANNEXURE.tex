...
The complete source code, datasets, and benchmark scripts used to derive the results in this report are securely version-controlled and maintained in the project's codebase repository. The implementation uses Python 3.13.5, PyTorch 2.9.1, and the Synthetic Data Vault (SDV) library for baseline comparisons.
